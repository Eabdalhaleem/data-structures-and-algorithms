...
const addValues = (arr) => {
  // Solution code here...
  let newArray = arr.reduce((e, value) => {
    e = e + value;
    return e;
  }, 0)
  return newArray
...
const addPurchases = (arr) => {
  // Solution code here...
  let objArray = arr.reduce((e, value) => {
    e = e + value.purchasePrice;
    return e;
  }, 0)
  return objArray
};
...
const returnNames = (arr) => {
  // Solution code here...
  let contArray = arr.reduce((e, value, index) => {
    e[index] = value.name;
    return e;
  },
...
const reversedString = (str) => {
  ...
  let newArray = strArr.reduce((e, value, index) => {
    e = e + strArr[(strArr.length) - 1 - index];
