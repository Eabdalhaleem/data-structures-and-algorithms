...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let numberRaiseArray=[];
  arr.forEach(value=>{
    numberRaiseArray.push(Math.pow(value, 3))
  })
  return numberRaiseArray ;
};
...
const addOne = (arr) => {
  // Solution code here...
  let incremenArray=arr.map(value=>{
    return value+1 ;
  })
  return incremenArray;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  let arrayContainString=arr.map(value=>{
    return value +"?";
  })
  return arrayContainString;
};
